...
export default function CreateIdeaPage() {
  ...
  const { register, handleSubmit, formState: { errors }, watch, setValue, getValues } = useForm<IdeaForm>({
  ...
  const createIdeaMutation = useMutation({
    ...
    onSuccess: (_, variables) => {
      toast.success(variables.status === "DRAFT" ? "Idea saved as draft" : "Idea submitted for review!");
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold tracking-tight">Create Sustainability Idea</h1>
      </div>
