        ...
        {impactStatsData.map((stat, i) => (
          ...
          >
            ...
            <div className="space-y-1">
              <h4 className="text-4xl md:text-5xl font-bold tracking-tighter text-zinc-900 dark:text-white leading-none">
                <CountUp end={stat.value} suffix={stat.suffix} enableScrollSpy scrollSpyOnce scrollSpyDelay={100} duration={2.5} />
              </h4>

              <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-400 group-hover:text-emerald-500 transition-colors">
                {stat.label}
              </p>
            </div>
